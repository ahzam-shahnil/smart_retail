...
import 'package:smart_retail/Screens/user_product_add.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection(kProductData).snapshots(),
                        ...
                        trailing: IconButton(
                            onPressed: () async {
                              _database.deleteItem(
                                  docId: data.id, collectionName: kProductData);
                            },
