...
// Project imports:
import 'package:smart_retail/Screens/register_screen/retailer_sign_up.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream:
            FirebaseFirestore.instance.collection(kRetailerData).snapshots(),
                        ...
                        trailing: IconButton(
                            onPressed: () async {
                              _database.deleteFirebaseUser(data['email'],
                                  data['password'], kRetailerData, data.id);
                            },
