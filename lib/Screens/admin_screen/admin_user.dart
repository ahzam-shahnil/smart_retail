...
// Project imports:
import 'package:smart_retail/Screens/register_screen/user_signup.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection(kUserData).snapshots(),
                        ...
                        trailing: IconButton(
                            onPressed: () async {
                              _database.deleteFirebaseUser(data['email'],
                                  data['password'], kUserData, data.id);
                            },
